...
def GUI(self, Gtk, GdkPixbuf):
    ...
    label.set_markup("<big>Welcome to <b>ArcoLinux</b></big>")
    ...
    button2_label.set_markup(
        "<span size='large'><b>Base Installation (Offline)</b></span>"
    )
    ...
    button8_label.set_markup(
        "<span size='large'><b>Update Arch Linux mirrors</b></span>"
    )
    ...
    button3.connect(
        "clicked", self.on_link_clicked, "https://arcolinux.info/releases-2023/"
    )
    ...
    button70.connect("query-tooltip", self.tooltip_callback, "Launch Arandr")
